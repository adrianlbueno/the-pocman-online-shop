...
const ShopItem = ({ url, name }) => {
  ...
  return (
    <div className="relative lg:w-1/3 sm:w-1/2 p-4">
      <div className="flex w-96 flex-col  text-gray-700 shadow-md">
        <div className="bg-gradient-to-r from-[#f02aa6] to-[#ff6f48] hover:bg-gradient-to-r hover:from-[#fff] hover:to-[#ff6f48]">
          <img
            src={url}
            alt={name}
