    ...
    <>
      <div className="w-full px-16 md:px-0 h-screen flex items-center justify-center">
        <div className="flex flex-col items-center justify-center px-4 md:px-8 lg:px-24 py-8">
          <p className=" font-nunito font-bold text-6xl md:text-7xl lg:text-9xl  tracking-wider text-[#C025D3]">
            404
          </p>
          ...
          <Link to="/">
            <button
              type="button"
              className=" font-nunito flex items-center space-x-2 bg-[#C025D3] hover:bg-blue-700 text-gray-100 px-4 py-2 mt-6 rounded transition duration-150"
            >
